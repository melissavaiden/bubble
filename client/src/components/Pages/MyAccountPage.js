    ...
    <>
      ...
      <form className='container'>
        <div className="row align-items-center">
          ...
          <input type='username' className='form-control col username-input' placeholder='username'></input>
          <button className='btn col' id='username' onClick={handleClick}>Edit</button>
        </div>
        <br></br>
        <div className='row align-items-center'> 
          <label className='form-label col'>Email:</label>
          <input type='email' className='form-control col email-input' placeholder='email'></input>
          <button className='btn col' id='email' onClick={handleClick}>Edit</button>
        </div>
        <br></br>
        <div className='row align-items-center'>
          <label className='form-label col'>Password:</label>
          <input type='password' className='form-control col password-input' placeholder='password'></input>
